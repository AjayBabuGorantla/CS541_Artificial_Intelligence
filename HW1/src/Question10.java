...
public class Question10 {
    ...
    public static void main(String[] args) {
        ...
        if (type_of_agent == 1) {
            ...
            System.out.println("The agent has took " + number_of_steps_to_clean + " steps. " + "The score is " + score);
            ...
            System.out.println("The agent has took " + number_of_steps_to_clean + " steps.");
